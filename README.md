...
```
<p align="center"><i>Statistical test suite results for random binary file ('rand.binary') generated by device.</i></p>

The directory `statistical_testing` contains some utilities for assessing and gathering data from the device, including a sample
